...
function fmt(array $arr): string { return '{' . implode(', ', $arr) . '}'; }
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="caja">
    ...
    <div class="caja-body">
        <form method="POST">
            ...
            <input type="text" name="conjunto_a" placeholder="Ej: 1, 2, 3, 4"
                   value="<?= htmlspecialchars($_POST['conjunto_a'] ?? '') ?>">
            <label>Conjunto B (separado por comas):</label>
            <input type="text" name="conjunto_b" placeholder="Ej: 3, 4, 5, 6"
